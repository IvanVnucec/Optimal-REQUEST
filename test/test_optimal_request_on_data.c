...
MU_TEST(test_call_OR_functions) {
	...
	for (int i=0; i<MEAS_LEN; i++) {
		printf("acc = %f %f %f\n", 
			test_meas_data_acc[i][0], 
			test_meas_data_acc[i][1],
			test_meas_data_acc[i][2]);

		printf("mag = %f %f %f\n", 
			test_meas_data_mag[i][0], 
			test_meas_data_mag[i][1],
			test_meas_data_mag[i][2]);

		printf("gyr = %f %f %f\n", 
			test_meas_data_gyr[i][0], 
			test_meas_data_gyr[i][1],
			test_meas_data_gyr[i][2]);

		printf("gyr = %f %f %f\n", 
			test_meas_data_euler_gt[i][0], 
			test_meas_data_euler_gt[i][1],
			test_meas_data_euler_gt[i][2]);
	}
